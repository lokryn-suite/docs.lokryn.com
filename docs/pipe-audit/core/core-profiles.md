...
**Notes** - `endpoint` points to your MinIO or S3-compatible service.
...
**Notes** - `connection_string` is pulled from the environment.
...
**Notes** - `service_account_json` should point to a service account key file, or inline JSON.
